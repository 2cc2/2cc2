...
![](http://antzuhl.cn:4000/get/@2cc2)
 <svg
      ...
      >
        <title id="titleId">Crescent&#12290;'s GitHub Stats, Rank: A+</title>
        <desc id="descId">Total Stars Earned: 0, Total Commits in 2023 : 0, Total Issues: 0, Contributed to (last year): 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 127.60747910765507;
      }
    }
